    ...
    <section class="py-2 text-center container">
      <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
          <h1 class="fw-light"><b>Detail Al-Quran</b></h1>
        </div>
      </div>
    </section>
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-1 g-3">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            <li class="list-group-item d-flex flex-column lh-sm">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="my-0">
                                        <span class="badge bg-success rounded-pill fs-5">{{ $item['nomor'] }}</span>
                                    </h6>
                                    <div class="fs-5 text-end">{{-- text-end class untuk Bootstrap 5, kalau masih menggunakan Bootstrap 4 gunakan class float-end --}}
