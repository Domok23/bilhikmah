                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        @if (session()->has('success'))
                            ...
                            <br>
                        @endif
                            <a href="/dashboard/kategori/create" class="btn btn-primary mb-3"><i class="fas fa-plus"></i> Tambah</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="/dashboard/kategori/{{ $item->id }}/edit" class="btn btn-warning">
