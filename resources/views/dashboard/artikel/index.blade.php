                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Manajemen Data Artikel</h3>
                        </div>
                        <div class="card-body">
                            ...
                            <br>
                            @endif
                            <a href="/dashboard/artikel/create" class="btn btn-success mb-3"><i class="fas fa-plus"></i>
                                Tambah</a>
                                ...
                                <table id="dataTable" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="/artikel/{{ $item->id }}" class="btn btn-sm btn-primary mb-1"
                                                    target="_blank">
                                                    <i class="fas fa-eye"></i> Lihat
                                                </a>
                                                <a href="/dashboard/artikel/{{ $item->id }}/edit"
